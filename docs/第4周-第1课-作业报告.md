...
![PID vs 计算力矩控制对比](../matlab/pid_vs_computed_torque_comparison.png)
...
| 文件 | 说明 |
|:-----|:-----|
| `matlab/two_link_dynamics.m` | 二连杆动力学方程函数 |
| `matlab/pid_controller.m` | PID控制器 |
| `matlab/computed_torque_controller.m` | 计算力矩控制器 |
| `matlab/run_comparison.m` | 主对比实验脚本 |
